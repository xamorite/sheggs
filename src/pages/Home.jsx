    ...
    <>
      ...
      <section id="video">
        <div className="wrap">
          ...
          <div className="grid-work reveal-stagger">
            <article className="work-card wide"><div className="ph tone-2" style={{padding:0, background:'#000'}}><iframe src="https://www.youtube-nocookie.com/embed/iXvSzygGSto" title="Video" loading="lazy" allowFullScreen style={{position:'absolute',inset:0,width:'100%',height:'100%',border:0}} /></div><span className="idx">01 — Commercial</span><div className="cap"><h3>Chocomalt</h3><span className="meta">Commercial · 2024</span></div></article>
          </div>
        </div>
      </section>
        ...
        <div className="wrap">
          ...
          <div className="gallery reveal-stagger is-in" style={{display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:'16px'}}>
            {['/assets/images/works/IMG_6023.JPG','/assets/images/works/IMG_2642.JPG','/assets/images/zombie/IMG_5694.JPG','/assets/images/works/IMG_2647.JPG','/assets/images/zombie/IMG_5704.JPG','/assets/images/IMG_4367.JPG'].map((src,i)=>(
              <div key={src} className="gallery-item" style={{position:'relative', aspectRatio:'4/5', overflow:'hidden'}}><div className="ph"><img src={src} alt="" loading="lazy" decoding="async" style={{position:'absolute',inset:0,width:'100%',height:'100%',objectFit:'cover'}}/></div></div>
            ))}
          </div>
